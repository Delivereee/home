    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-10">
      <div className="flex justify-around items-center py-2">
        ...
        >
          ...
          <span className={`text-xs mt-1 ${isActive('/') ? 'text-red-400' : 'text-gray-500'}`}>Home</span>
        </div>
        ...
        >
          ...
          <span className={`text-xs mt-1 ${isActive('/cart') ? 'text-red-400' : 'text-gray-500'}`}>Cart</span>
        </div>
      </div>
    </div>
  );
